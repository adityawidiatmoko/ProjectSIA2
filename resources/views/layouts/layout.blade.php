                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-arrow-circle-right" href=" {{ route('pemesanan.transaksi') }}">
                            Pemesanan</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('pembelian.transaksi') }}">
                            Pembelian</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('retur.transaksi') }}">
                            Retur</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Create By: Your Name<br>Copyright &copy; wowo 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
