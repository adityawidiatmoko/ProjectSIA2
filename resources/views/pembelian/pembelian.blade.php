            ...
            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <a href="{{url('/pembelian-beli/'.Crypt::encryptString($pesan->no_pesan))}}"
                                class="d-none d-sm-inline-block btn btn-sm btn-success shadowsm"><i
                                    class="fas fa-edit fa-sm text-white-50"></i> Beli</a>
                            ...
                            <a href="{{url('/pembelian/hapus/'.Crypt::encryptString($pesan->no_pesan))}}"
